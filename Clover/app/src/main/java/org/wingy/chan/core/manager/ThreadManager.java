...
import org.wingy.chan.core.loader.Loader;
import org.wingy.chan.core.loader.LoaderPool;
import org.wingy.chan.core.manager.ReplyManager.DeleteListener;
import org.wingy.chan.core.manager.ReplyManager.DeleteResponse;
import org.wingy.chan.core.model.Loadable;
import org.wingy.chan.core.model.Pin;
...
public class ThreadManager implements Loader.LoaderListener {
    ...
    public void openReply(boolean startInActivity) {
        if (loader == null || loader.getOP() == null)
            return;
        if (loader.getOP().closed) {
